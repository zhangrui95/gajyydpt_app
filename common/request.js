...
const request = (url = '', data = {}, type = 'GET', urlType = '', upLoadType = '', fileAddr,
	header = url == '/data/getCheckPointListForClient' ? {
		'Content-Type': 'application/json;charset=UTF-8',
		'appCredential': '',
		'userCredential': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.-VIiwiam9iIjpbeyJjb2RlIjoiMjAwMDAxIiwibmFtZSI6IuawkeitpiJ9XSwiY29udGFjdCI6IjEzNjEzNjAwODMwIiwiaXNBZG1pbiI6MCwiZXhwIjoxNjAxMjU0OTMzfQ.bv2L1wKKxFReqeWN2so8Tu4cd_OFMWw5s_u-3g-H9vE'
	} : {
							...
							success: function(res) {
								if (res.networkType != 'none') {
									...
									if (upLoadType == 'file') {
										...
										console.log(data, configUrl[urlType] + url)
										uni.request({
											method: type,
											url: configUrl[urlType] + url,
											data: data,
											header: header,
											dataType: url == '/data/getXml' ? 'text' : 'json',
										}).then((response) => {
